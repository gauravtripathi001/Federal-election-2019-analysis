SELECT x.riding_number 
FROM   (SELECT result.riding_number, 
               result.winning, 
               CASE 
                 WHEN result.winning = 'conservative' THEN 
                 c.conservative_candidate 
                 ...
                 WHEN result.winning = 'bloc_quebecois' THEN 
                 c.bloc_quebecois_candidate 
                 WHEN result.winning = 'peoples_party' THEN 
                 c.peoples_party_candidate 
               END AS NAME 
        FROM   candidates AS c 
               JOIN (SELECT v.riding_number, 
                            CASE 
                              ...
                              'conservative' 
                              WHEN m.maxcol = v.liberal_vote_share THEN 
                              'liberal' 
